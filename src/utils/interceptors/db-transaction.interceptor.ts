...
export const ENTITY_MANAGER_KEY = 'DB_ENTITY_MANAGER';
...
export class TransactionInterceptor implements NestInterceptor {
  ...
  async intercept(
    ...
    this.cls.setIfUndefined(ENTITY_MANAGER_KEY, queryRunner.manager);
    ...
    return next.handle().pipe(
      ...
      finalize(async () => {
        ...
        this.cls.set(ENTITY_MANAGER_KEY, undefined);
      }),
    );
  }
}
